    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult AddAdminRole(string userName) 
        {
            if (ModelState.IsValid)
            {
                ...
                var oldRole = UserManager.RemoveFromRole(currentUser.Id, "Customer");
        ...
        public ActionResult RemoveAdminRole(string userName)
        {
            if (ModelState.IsValid)
            {
                var user = UserManager.FindByName(userName);
                var currentUser = UserManager.FindByName(user.UserName);
                var roleResult = UserManager.RemoveFromRole(currentUser.Id, "Administrator");
                var newRole = UserManager.AddToRole(currentUser.Id, "Customer");
                return RedirectToAction("Index", "Users");
            }
            // If we got this far, something failed, redisplay form
            return View();
